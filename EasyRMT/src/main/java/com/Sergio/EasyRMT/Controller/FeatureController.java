...
public class FeatureController {
    ...
    public ModelAndView getFeatureListView(@PathVariable int projectId, ModelAndView mav){
        ...
        mav.setViewName("featureDashboard");
     ...
     */
    @RequestMapping(value = PATH_BASE+"feature/create", method = RequestMethod.GET)
    ...
    public ModelAndView createEpic(@PathVariable int projectId, @ModelAttribute @Valid FeatureDom feature){
        List<ProjectDom> projectDomList = projectService.getProjects();
        ProjectDom project = projectService.getProject(projectId);
